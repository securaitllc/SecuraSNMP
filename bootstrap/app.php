...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        // Absolute session age. A Laravel lifetime is inactivity, not age, and this
        // app polls every 30s — so without this an open tab never expires, and
        // remember-me silently re-authenticates whatever does. Runs before the
        // two-factor gate so an over-age session is ended, not re-enrolled.
        $middleware->appendToGroup('api', EnforceMaxSessionAge::class);
