...
// Super-admin-only nav items (OSINT) are hidden from everyone else. The API enforces
// the same gate server-side; this just keeps them out of the menu.
const auth = useAuthStore()
const navItems = computed(() => navItemsRaw.filter((i: any) => !i.superAdmin || auth.isSuperAdmin))
