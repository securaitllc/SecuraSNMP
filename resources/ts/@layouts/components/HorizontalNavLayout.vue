...
<template>
  ...
  >
    ...
    >
      <!-- One 44px bar: identity, the nav, then the live cluster. The template
           stacked navbar over nav on two rows; a NOC reads one. -->
      <div class="layout-navbar terminal-bar">
        <div class="navbar-content-container terminal-bar__row">
          <slot name="brand" />
          <div class="layout-horizontal-nav terminal-bar__nav">
