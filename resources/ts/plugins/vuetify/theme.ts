...
export const themes: Record<string, ThemeDefinition> = {
  ...
  dark: {
    ...
    colors: {
      ...
      // #D97706 is also weak on a near-black ground (~5.4:1 against #0B0E14,
      // where #F5A623 is ~9.5:1) — amber is the "degraded" signal on a wall
      // display and has to read from across the room.
      'success': '#2BA24E',
