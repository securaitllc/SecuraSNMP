...
// Nodus brand — T568B green pair (#2BA24E primary / #45C46B raised on dark).
export const staticPrimaryColor = '#2BA24E'
export const staticPrimaryDarkenColor = '#23913F'
...
export const themes: Record<string, ThemeDefinition> = {
  light: {
    ...
    colors: {
      ...
      'on-error': '#fff',
      // Softer paper (less glare than pure-bright #F7F7F9) with a slightly muted
      // ink — easier on the eyes for long NOC sessions.
      'background': '#ECEDEF',
      'on-background': '#2B303B',
      'surface': '#FBFBFC',
      'on-surface': '#2B303B',
      'grey-50': '#FAFAFA',
      'grey-100': '#F5F5F5',
