 ...
 * that also means "circuit healthy" cannot simultaneously mean "this button is
 * primary" — severity is load-bearing in this app, so the accent has to sit outside
 * the red/amber/green vocabulary entirely.
 */
export const staticPrimaryColor = '#5B5BD6'
export const staticPrimaryDarkenColor = '#4A4AC0'
