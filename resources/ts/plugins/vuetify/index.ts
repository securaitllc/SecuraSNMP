...
export default function (app: App) {
  ...
  const cookieThemeValues = {
    ...
    themes: {
      light: {
        colors: {
          'primary': cookieRef('lightThemePrimaryColorV2', staticPrimaryColor).value,
          'primary-darken-1': cookieRef('lightThemePrimaryDarkenColorV2', staticPrimaryDarkenColor).value,
        },
      },
      dark: {
        colors: {
          'primary': cookieRef('darkThemePrimaryColorV2', staticPrimaryColor).value,
          'primary-darken-1': cookieRef('darkThemePrimaryDarkenColorV2', staticPrimaryDarkenColor).value,
        },
      },
    },
  }
