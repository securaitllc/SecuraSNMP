      ...
      <template #item.name="{ item }">
        <span class="d-flex align-center ga-2">
          ...
          <span class="d-flex flex-column">
            ...
            <span v-if="item.site_number" class="site-number">#{{ item.site_number }}</span>
          </span>
        </span>
      </template>
        ...
        <div class="ce-body">
          ...
          <div class="ce-content">
            ...
            <section id="sec-identity" class="ce-sect">
              ...
              <VRow dense>
                ...
                <VCol cols="12" :sm="form.site_type === 'branch' ? 5 : 12">
                  <div class="ce-flabel">Type</div>
                  <VBtnToggle v-model="form.site_type" mandatory divided density="comfortable" color="primary" class="ce-seg">
                    <VBtn value="branch" size="small">Branch</VBtn>
                    <VBtn value="hub" size="small">Hub</VBtn>
                  </VBtnToggle>
                </VCol>
            ...
            <section id="sec-notes" class="ce-sect">
              <div class="ce-sh"><span class="ce-num">03</span><h3>Notes</h3></div>
