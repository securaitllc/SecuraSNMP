...
// Always alphabetical by site name. Impacted sites still stand out via the red
// row highlight (rowProps) and the "N sites impacted" banner — no need to float
// them to the top out of name order.
