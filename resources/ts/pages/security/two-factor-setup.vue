    ...
    <VCard flat :max-width="460" class="pa-6 pa-lg-8 mfa-card">
      ...
      <template v-else>
        ...
        <div class="d-flex flex-column ga-2">
          <VBtn block color="primary" @click="finish">I've saved my codes — continue</VBtn>
          <VBtn block variant="tonal" prepend-icon="ri-file-copy-line" @click="copyCodes">
...
.mfa-card { inline-size: 100%; max-inline-size: 460px; border: 1px solid rgba(var(--v-border-color), var(--v-border-opacity)); overflow: hidden; }
...
.mfa-secret__key {
  font-family: ui-monospace, Menlo, monospace; letter-spacing: 2px; font-size: 0.9rem;
  background: rgba(var(--v-theme-on-surface), 0.06); padding: 6px 12px; border-radius: 8px;
  max-inline-size: 100%; word-break: break-all; text-align: center;
}
