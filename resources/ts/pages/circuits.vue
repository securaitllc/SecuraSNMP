...
const headers = [
  ...
  { title: 'Circuit ID', key: 'circuit_id', width: 128 },
  { title: 'Status', key: 'status', width: 140 },
  { title: 'Response Time', key: 'health', sortable: false, width: 112 },
      ...
      <template #item.circuit_id="{ item }">
        <div class="cx-ckt">
          ...
          <div class="cx-ckt-bw mono">
            ...
            <span :class="(item.sustained_loss_pct ?? item.last_loss_pct ?? 0) > 0 ? 'text-warning' : 'text-success'">{{ item.sustained_loss_pct ?? item.last_loss_pct ?? 0 }}%</span>
          </div>
        </div>
      </template>
...
.cx-table :deep(th:nth-child(4)), .cx-table :deep(td:nth-child(4)) { width: 128px; }
.cx-table :deep(th:nth-child(5)), .cx-table :deep(td:nth-child(5)) { width: 140px; }
.cx-table :deep(th:nth-child(6)), .cx-table :deep(td:nth-child(6)) { width: 112px; }
