    ...
    >
      ...
      <template #item.circuit_id="{ item }">
        <div class="cx-ckt">
          ...
          <div class="cx-ckt-bw mono">
            ...
            <span :class="(item.sustained_loss_pct ?? item.last_loss_pct ?? 0) > 0 ? 'text-warning' : 'cx-loss-ok'">{{ item.sustained_loss_pct ?? item.last_loss_pct ?? 0 }}% loss</span>
          </div>
        </div>
      </template>
      <template #item.bandwidth="{ item }">
        ...
        >
          ...
          <div class="cx-bw-row">
            <svg class="cx-bw-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round">
              <title>Download</title><path d="M12 5v14" /><path d="m19 12-7 7-7-7" />
            </svg>
          ...
          <div class="cx-bw-row">
            <svg class="cx-bw-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round">
              <title>Upload</title><path d="M12 19V5" /><path d="m5 12 7-7 7 7" />
            </svg>
...
.cx-bw-ico { inline-size: 12px; block-size: 12px; flex-shrink: 0; color: rgba(var(--v-theme-on-surface), .5); }
.cx-bw-track {
  flex: 1;
  block-size: 6px;
  border-radius: 3px;
