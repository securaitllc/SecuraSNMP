      ...
      >
        <VCard>
          <VCardItem>
            ...
            <template #append>
              <div class="d-flex align-center ga-3">
                <VBtnToggle v-model="alarmView" mandatory density="compact" variant="outlined" color="primary" class="seg-toggle--wide">
                  <VBtn value="grouped" size="small" prepend-icon="ri-router-line">By ISP</VBtn>
                  <VBtn value="flat" size="small" prepend-icon="ri-list-check">Flat</VBtn>
                </VBtnToggle>
                <VChip
                  size="small"
