...
const kpis = computed(() => {
  ...
  return [
    ...
    },
    {
      ...
      of: c.devices,
      detail: `${c.devices - (c.devices_reachable ?? c.devices)} unreachable`,
      tone: '',
    ...
    },
    {
      ...
      detail: `${c.circuits_down} down · ${c.circuits_maintenance ?? 0} in maintenance`,
      tone: c.circuits_down > 0 ? '' : 'success',
