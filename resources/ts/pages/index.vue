...
function troubleshootAlert(alert: DashboardAlert) {
  if (alert.type === 'interface' && alert.device_id && alert.if_name) {
...
<template>
  <div>
    <div class="d-flex align-center justify-end ga-3 mb-3">
          ...
          <VCardText v-else>
            ...
            >
              ...
              <div class="alert-aside">
                ...
                <!-- In-place NOC actions, same as By-ISP (analyst ack/clear, admin mute) -->
                <div
                  v-if="auth.canAct && alert.actions"
                  class="alert-acts"
                  @click.stop
                >
                  <VBtn
...
.alert-acts { display: flex; gap: 4px; margin-top: 5px; }
