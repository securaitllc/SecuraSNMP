...
/* A bounded viewport (not height:auto) so a large fabric fits and frames instead of
   growing into a giant scroll; Ctrl+scroll / the zoom buttons read individual labels. */
.topo-svg { display: block; width: 100%; block-size: min(78vh, 820px); min-block-size: 460px; touch-action: none; cursor: grab; }
