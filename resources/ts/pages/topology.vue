            ...
            <div class="sn-path__hops">
              <template v-for="(hn, i) in tracePathNodes" :key="hn.id">
                ...
                <button type="button" class="sn-path__hop" :class="{ on: hn.id === selectedId }" @click="selectedId = hn.id">
                  ...
                  <span v-if="hn.util != null" class="sn-path__util" :title="`busiest link ${hn.util}%`">
                    <span class="sn-path__util-bar"><span class="sn-path__util-fill" :style="{ width: `${hn.util}%`, background: metricColor(hn.util) }" /></span>
                    <span class="sn-path__util-pct">{{ hn.util }}%</span>
                  </span>
                </button>
              </template>
            </div>
