...
type Row = {
  ip: string
  state: 'assigned' | 'discovered' | 'conflict' | 'free' | 'reserved'
  also_on?: string | null
  mac: string | null
  vendor: string | null
...
const detailFilter = ref<'all' | 'assigned' | 'discovered' | 'conflict' | 'free' | 'reserved'>('all')
      ...
      <VCard flat class="d-flex flex-column" style="block-size: 100%">
        ...
        <div class="pa-5 flex-grow-1 overflow-auto">
          ...
          <div class="list-pills mb-3">
            <button
              v-for="f in ['all', 'free', 'assigned', 'reserved', 'discovered', 'conflict']" :key="f"
