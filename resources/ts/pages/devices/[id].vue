      ...
      <VCard v-if="selectedInterface">
        <VCardItem>
          ...
          <template #append>
            <div class="d-flex align-center ga-3">
              ...
              <VBtnToggle v-model="interfaceRange" density="comfortable" variant="outlined" mandatory class="range-pills">
        ...
        <VCardText>
          ...
          <div class="if-chart-head">
            <VBtnToggle v-model="chartMetric" density="comfortable" variant="outlined" mandatory class="range-pills">
