        ...
        <VCardText>
          ...
          <div class="if-chart-head">
            <div class="d-flex align-center ga-3 flex-wrap">
              <VBtnToggle v-model="chartMetric" variant="outlined" mandatory class="if-metric-toggle">
                <VBtn v-for="o in chartMetricOptions" :key="o.value" :value="o.value" size="small">{{ o.label }}</VBtn>
              </VBtnToggle>
              <span class="text-caption text-medium-emphasis">{{ interfaceRange }}</span>
            </div>
            <span v-if="interfaceMetrics.length && chartMetric === 'traffic'" class="text-caption text-medium-emphasis">
...
.if-metric-toggle .v-btn { min-inline-size: 84px; }
