    ...
    >
      ...
      <VCardText class="pb-0">
        <div class="d-flex flex-wrap align-center ga-2">
          ...
          />
          <VSpacer />
          <VBtnToggle v-model="alarmSeverityFilter" variant="outlined" divided rounded="lg" class="app-filter-toggle">
            <VBtn value="critical" size="small" color="error">
              <span class="filter-dot bg-error" /> Critical
            </VBtn>
            <VBtn value="warning" size="small" color="warning">
              <span class="filter-dot bg-warning" /> Warning
            </VBtn>
            <VBtn value="info" size="small" color="info">
              <span class="filter-dot bg-info" /> Info
            </VBtn>
          </VBtnToggle>
          <VBtnToggle v-model="alarmStatusFilter" variant="outlined" divided rounded="lg" class="app-filter-toggle">
            <VBtn value="active" size="small" color="error">Active</VBtn>
            <VBtn value="cleared" size="small" color="success">Cleared</VBtn>
          </VBtnToggle>
        </div>
      </VCardText>
