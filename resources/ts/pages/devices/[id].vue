...
const pageSections = computed(() => [
  { id: 'overview', label: 'Response Time', icon: 'ri-pulse-line', show: true },
  { id: 'device-detail', label: 'Device Detail', icon: 'ri-server-line', show: true },
  { id: 'endpoints', label: 'Connected Endpoints', icon: 'ri-plug-line', show: sortedNeighbors.value.length > 0 },
  { id: 'interface-alarms', label: 'Interface Alarms', icon: 'ri-alarm-warning-line', show: alarmedInterfaces.value.length > 0 },
  { id: 'interface-alarm-history', label: 'Interface Alarm History', icon: 'ri-history-line', show: interfaceHistory.value.length > 0 },
  { id: 'alarm-history', label: 'Alarm History', icon: 'ri-alarm-warning-line', show: true },
  { id: 'interfaces', label: 'Interfaces & VLANs', icon: 'ri-node-tree', show: true },
  { id: 'vulnerabilities', label: 'Vulnerabilities', icon: 'ri-shield-keyhole-line', show: true },
].filter(s => s.show))
  ...
  <div>
    ...
    <div class="dev-body">
      ...
      <aside class="dev-index">
        ...
        <VList density="compact" nav class="dev-index__list">
          <VListItem
...
.dev-index {
  position: sticky;
  top: 84px;            /* clears the 64px navbar + a little breathing room */
  flex: 0 0 218px;
  inline-size: 218px;
...
.dev-index__list :deep(.v-list-item-title) { font-size: 0.8125rem; }
.dev-index__list :deep(.v-list-item--active) { font-weight: 600; }
