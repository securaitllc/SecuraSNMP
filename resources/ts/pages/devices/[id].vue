    ...
    >
      ...
      <VCardText class="pb-0">
        <div class="d-flex flex-wrap align-center ga-2">
          ...
          />
          <VSpacer />
          <VBtnToggle v-model="alarmSeverityFilter" variant="outlined" class="app-filter-toggle">
          ...
          <VBtnToggle v-model="alarmStatusFilter" variant="outlined" class="app-filter-toggle">
