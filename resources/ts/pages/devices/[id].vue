...
async function startMaintenance() {
  ...
  try {
    await api(`/api/devices/${deviceId.value}/maintenance`, {
      method: 'POST',
      body: { hours: maintHours.value, reason: maintReason.value || null },
    })
    ...
    <VDialog v-model="maintOpen" max-width="440">
      <VCard>
        ...
        <VCardText>
          ...
          <VSelect
            v-model="maintHours"
            :items="[{ title: '1 hour', value: 1 }, { title: '2 hours', value: 2 }, { title: '4 hours', value: 4 }, { title: '8 hours', value: 8 }, { title: '24 hours', value: 24 }]"
        ...
        <VCardActions class="justify-end pa-4 pt-0">
          ...
          <VBtn color="primary" :loading="maintSaving" @click="startMaintenance">
            Start maintenance
          </VBtn>
        </VCardActions>
      </VCard>
