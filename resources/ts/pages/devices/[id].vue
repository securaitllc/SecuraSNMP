    ...
    >
      ...
      <VCardText class="pb-0">
        <div class="d-flex flex-wrap align-center ga-2">
          ...
          />
          <VSpacer />
          <VBtnToggle v-model="alarmSeverityFilter" variant="outlined" class="alarm-filter-toggle">
            <VBtn value="critical" size="small">Critical</VBtn>
            <VBtn value="warning" size="small">Warning</VBtn>
            <VBtn value="info" size="small">Info</VBtn>
          </VBtnToggle>
          <VBtnToggle v-model="alarmStatusFilter" variant="outlined" class="alarm-filter-toggle">
...
/* Filter toggles: buttons hug their label instead of a fixed min-width that
   squeezed the text together. */
.alarm-filter-toggle { block-size: 34px; }
.alarm-filter-toggle :deep(.v-btn) {
