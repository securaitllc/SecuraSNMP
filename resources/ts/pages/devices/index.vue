    ...
    >
      ...
      <template #item.name="{ item }">
        <div class="d-flex flex-column py-1">
          ...
          <CopyBtn v-if="item.ip_address" :text="item.ip_address" class="text-medium-emphasis text-caption" />
        ...
        <div class="ce-body">
          ...
          <div class="ce-content">
            ...
            <section id="sec-snmp" class="ce-sect">
              ...
              <VRow dense>
                <VCol cols="12">
                  <div class="ce-flabel">SNMP version</div>
                  <VBtnToggle v-model="form.snmp_version" mandatory divided density="comfortable" color="primary" class="ce-seg" style="max-width:240px">
                    <VBtn v-for="o in snmpVersionOptions" :key="o.value ?? o" :value="o.value ?? o" size="small">{{ o.title ?? o }}</VBtn>
                  </VBtnToggle>
                </VCol>
