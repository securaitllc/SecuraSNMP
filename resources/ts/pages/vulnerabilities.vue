      ...
      <VCardItem>
        ...
        <template #append>
          <div class="d-flex flex-wrap align-center ga-2">
            <VBtnToggle v-model="vendorFilter" variant="outlined" divided rounded="lg" class="app-filter-toggle">
              <VBtn v-for="v in vendors" :key="v" :value="v" size="small" color="primary" class="text-capitalize">{{ v }}</VBtn>
            </VBtnToggle>
            <VBtnToggle v-model="stateFilter" variant="outlined" divided rounded="lg" class="app-filter-toggle">
              <VBtn value="open" size="small" color="error">Open</VBtn>
              <VBtn value="acknowledged" size="small" color="success">Ack’d</VBtn>
            </VBtnToggle>
          </div>
        </template>
      </VCardItem>
