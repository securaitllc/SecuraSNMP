        ...
        <VCard class="h-100">
          ...
          <VList class="py-0">
            ...
            <VListItem v-if="!summary?.top_devices?.length">
              <VListItemTitle class="text-medium-emphasis"><VIcon icon="ri-shield-check-line" size="16" color="success" class="me-1" />No exposed devices</VListItemTitle>
            </VListItem>
          </VList>
        </VCard>
      </VCol>
        ...
        <template #append>
          <div class="list-pills">
            <button
              ...
              type="button"
              class="list-pill text-capitalize"
              :class="{ 'list-pill--on': vendorFilter === v }"
            ...
            <button
              type="button"
              class="list-pill"
              :class="{ 'list-pill--on': stateFilter === 'open' }"
              @click="stateFilter = stateFilter === 'open' ? null : 'open'"
            >
              <span class="list-pill__d" style="background: rgb(var(--v-theme-error));" />
              Open
            </button>
            <button
              type="button"
              class="list-pill"
              :class="{ 'list-pill--on': stateFilter === 'acknowledged' }"
