      ...
      <VCardItem>
        ...
        <template #append>
          <div class="d-flex flex-wrap align-center ga-2">
            <VBtnToggle v-model="vendorFilter" variant="outlined" class="app-filter-toggle">
              <VBtn v-for="v in vendors" :key="v" :value="v" size="small" class="text-capitalize">{{ v }}</VBtn>
            </VBtnToggle>
            <VBtnToggle v-model="stateFilter" variant="outlined" class="app-filter-toggle">
