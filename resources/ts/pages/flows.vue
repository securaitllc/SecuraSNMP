...
const hours = ref(1)
const rangeOptions = [{ title: 'Last hour', value: 1 }, { title: 'Last 6 hours', value: 6 }, { title: 'Last 24 hours', value: 24 }, { title: 'Last 48 hours', value: 48 }, { title: 'Last 7 days', value: 168 }, { title: 'Last 30 days', value: 720 }]
...
// Traffic categories. These identify a KIND of traffic, never a health — so the
// ramp deliberately avoids the severity palette. SaaS was drawn in #2BA24E, the
// exact green that means "healthy" everywhere else in the app, with Voice and
// Streaming close enough to green and amber to read the same way: a tall green
// band on the flows chart looked like a verdict instead of a legend entry.
const CAT_HEX: Record<string, string> = { Web: '#26C6F9', SaaS: '#4C8DFF', Voice: '#14B8A6', Streaming: '#8B7CF6', VPN: '#5A93F7', 'File sharing': '#9C6ADE', Directory: '#EC6EAD', Database: '#F4A0C0', 'Remote access': '#DB2777', 'Video surveillance': '#B084E8', Infrastructure: '#8792A8', Management: '#6D788D', Email: '#B084E8', Updates: '#A0AEC0', Other: '#5B6472' }
...
const chartOptions = computed(() => ({
  ...
  colors: ['#4C8DFF', '#26C6F9', '#8B7CF6', '#5A93F7', '#9C6ADE', '#14B8A6', '#5B6472'],
