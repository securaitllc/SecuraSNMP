...
interface GAlarm { key: string, id: number | null, alarm_id: string | null, severity: string, description: string | null, ticket_number: string | null, first_seen_at: string, device_name: string | null, device_id?: number | null, last_neighbor?: string | null, macs?: GMac[], macs_more?: number, acknowledged_at?: string | null, actions?: GActions }
      ...
      >
        ...
        <div class="ag-alarms">
          <div v-for="a in g.alarms" :key="a.key" class="ag-alarm" :class="a.severity">
            ...
            <RouterLink v-if="a.device_id" :to="`/devices/${a.device_id}`" class="ag-dev ag-dev--link" title="Open device to investigate">
...
.ag-alarm { display: flex; align-items: center; flex-wrap: wrap; gap: 14px; padding: 9px 12px; border-radius: 8px;
...
.ag-dev { display: inline-flex; align-items: center; gap: 3px; font-family: ui-monospace, monospace; font-size: .68rem;
