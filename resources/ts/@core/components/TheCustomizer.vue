...
watch(
  () => configStore.theme,
  () => {
    const cookiePrimaryColor = cookieRef(`${vuetifyTheme.name.value}ThemePrimaryColorV2`, null).value
...
const setPrimaryColor = useDebounceFn((color: { main: string; darken: string }) => {
  ...
  cookieRef<string | null>(`${vuetifyTheme.name.value}ThemePrimaryColorV2`, null).value = color.main
  cookieRef<string | null>(`${vuetifyTheme.name.value}ThemePrimaryDarkenColorV2`, null).value = color.darken
...
const resetCustomizer = async () => {
  if (isCookieHasAnyValue.value) {
    ...
    cookieRef('lightThemePrimaryColorV2', staticPrimaryColor).value = staticPrimaryColor
    cookieRef('darkThemePrimaryColorV2', staticPrimaryColor).value = staticPrimaryColor
    cookieRef('lightThemePrimaryDarkenColorV2', staticPrimaryDarkenColor).value = staticPrimaryDarkenColor
    cookieRef('darkThemePrimaryDarkenColorV2', staticPrimaryDarkenColor).value = staticPrimaryDarkenColor
