...
watch(
  () => configStore.theme,
  () => {
    const cookiePrimaryColor = cookieRef(`${vuetifyTheme.name.value}ThemePrimaryColorV3`, null).value
...
const setPrimaryColor = useDebounceFn((color: { main: string; darken: string }) => {
  ...
  cookieRef<string | null>(`${vuetifyTheme.name.value}ThemePrimaryColorV3`, null).value = color.main
  cookieRef<string | null>(`${vuetifyTheme.name.value}ThemePrimaryDarkenColorV3`, null).value = color.darken
...
const resetCustomizer = async () => {
  if (isCookieHasAnyValue.value) {
    ...
    cookieRef('lightThemePrimaryColorV3', staticPrimaryColor).value = staticPrimaryColor
    cookieRef('darkThemePrimaryColorV3', staticPrimaryColor).value = staticPrimaryColor
    cookieRef('lightThemePrimaryDarkenColorV3', staticPrimaryDarkenColor).value = staticPrimaryDarkenColor
    cookieRef('darkThemePrimaryDarkenColorV3', staticPrimaryDarkenColor).value = staticPrimaryDarkenColor
