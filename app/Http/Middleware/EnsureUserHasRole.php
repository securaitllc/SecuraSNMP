...
class EnsureUserHasRole
{
     ...
     * RestrictDisplayRole.
     */
    // super_admin sits ABOVE admin — a superset. Existing admins do NOT inherit it;
    // only super_admin (rank 4) satisfies role:super_admin, gating the OSINT tool.
    private const RANK = ['display' => 0, 'viewer' => 1, 'analyst' => 2, 'admin' => 3, 'super_admin' => 4];
