...
class CircuitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Contracted bandwidth (Mbps) — what the ISP contract provides, e.g. 300/20.
            'contract_down_mbps' => ['nullable', 'integer', 'min:0', 'max:1000000'],
            'contract_up_mbps' => ['nullable', 'integer', 'min:0', 'max:1000000'],
