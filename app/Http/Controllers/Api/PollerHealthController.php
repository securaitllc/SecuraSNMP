...
class PollerHealthController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        ...
        $channels = NotificationChannel::where('enabled', true)->count();
        ...
        return response()->json([
            ...
            'alerting' => [
                ...
                'can_notify' => $channels > 0,
                'warning' => $channels === 0
                    ? 'No notification channel is enabled. Alarms are raised and recorded, but nobody is told — the dashboard is the only way to find out.'
                    : null,
            ],
        ], $healthy ? 200 : 503);
    }
