...
{
    public function index(DependencyResolver $resolver): JsonResponse
    {
        ...
        return response()->json([
            ...
            'suppressed_alarm_ids' => array_values(array_unique(array_merge(...array_map(fn ($i) => $i['suppressed_alarm_ids'], $incidents) ?: [[]]))),
        ]);
    }
}
