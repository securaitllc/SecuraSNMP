    ...
    public function index(): JsonResponse
    {
        ...
        return response()->json([
            ...
            'counts' => [
                ...
                // Down tunnels come from two signals: the SSH-polled tunnel table
                // and EdgeConnect 'tunnel_down' alarms (source 'Tunnel') polled
                // over SNMP — devices whose tunnels aren't SSH-polled still count.
                'tunnels_down' => Tunnel::where('status', 'down')->count()
                    + DeviceAlarm::whereNull('cleared_at')->where('alarm_id', 'like', 'ec:%:Tunnel')->count(),
