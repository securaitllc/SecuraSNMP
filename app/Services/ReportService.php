...
class ReportService
{
    ...
    private function siteLeases(array $filters): array
    {
        ...
        $label = ['expired' => 'Expired', 'warning' => 'Ends ≤90d', 'notice' => 'Ends ≤180d', 'ok' => 'OK', 'none' => 'Not set'];
        ...
        return [
            ...
            'summary' => [
                ...
                ['label' => 'No date yet', 'value' => (string) $sites->filter(fn (Site $s) => $s->leaseStatus() === 'none')->count()],
            ],
        ];
    }
