...
class HostnamePoller
{
    ...
    /**
     * How often sysName is re-read, for every device.
     *
     * Was 6 hours. An EdgeConnect renamed on the console on 18 September went
     * unnoticed for the rest of that window, and because tunnel labels are built
     * from the hostname, every tunnel symptom for that branch was filed against the
     * wrong site for as long as the record was stale. One walk of a single scalar
     * across ~300 devices is cheap; being six hours wrong about what a box is called
     * is not.
     */
