...
class MonitorCircuits extends Command
{
     ...
     *
     * Eight is bounded work: 255 circuits at ~11s each is under six minutes, spread
     * across sweeps rather than spiking one. A monitor that destabilises the host it
     * runs on is worse than no monitor, because it reports the damage as a fleet outage.
     */
    private const PING_CONCURRENCY = 8;
