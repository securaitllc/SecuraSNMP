...
class MonitorCircuits extends Command
{
    ...
    public function handle(): int
    {
        ...
        // circuit crosses into loss the poller traces the path, so the hop is on record
        // while the loss is happening rather than reconstructed after the carrier fixed it.
        $monitor->prober = new CircuitPathProber;
