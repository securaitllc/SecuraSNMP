    ...
    public function handle(): int
    {
        $monitor = new CircuitMonitor(
            function (string $ip): ?array {
                ...
                // ping -c5 -W2 finishes in well under this; the cap stops a wedged
                // ping process from burning Symfony's default 60s and slowing the
                // whole sweep (one stalled circuit must not starve the fleet).
