...
class MonitorDevices extends Command
{
    ...
    public function handle(): int
    {
        $monitor = new DeviceMonitor(function (string $ip): ?float {
            ...
            // Cap a wedged ping so one device cannot stall the fleet sweep (default
            // Symfony timeout is 60s; this ping needs a couple of seconds at most).
        ...
        $this->pollForever('devices', 60, fn () => $monitor->checkAll(fn () => $this->beat()));
    }
}
