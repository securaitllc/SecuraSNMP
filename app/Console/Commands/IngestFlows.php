...
class IngestFlows extends Command
{
    ...
    public function handle(): int
    {
        ...
        // Heartbeat label MUST match the entrypoint's supervise label ('flows-ingest')
        // — else the supervisor looks for the wrong .beat file, never sees a beat, and
        // kills the loop every 300s.
        $this->pollForever('flows-ingest', $interval, function () use ($file, $ingestor): void {
