...
export const { themeConfig, layoutConfig } = defineThemeConfig({
  app: {
    // Cast: the template types this as Lowercase<string>, but we want the
    // brand rendered with its real casing (a text-capitalize class leaves it as-is).
    title: 'Nodus' as Lowercase<string>,
