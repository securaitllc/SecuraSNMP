...
class InterfacePollerTest extends TestCase
{
    ...
    public function test_juniper_vlan_mib_provides_the_real_tag(): void
    {
        ...
        // (2, 4) which is NOT the tag (4, 999). This source wins over Q-BRIDGE.
        (new InterfacePoller($this->fakeWalker([
            '.1.3.6.1.4.1.2636.3.40.1.5.1.5.1.5' => "jnx.2 = Gauge32: 4\njnx.4 = Gauge32: 999",
            '.1.3.6.1.4.1.2636.3.40.1.5.1.5.1.2' => "jnx.2 = STRING: ENDPOINTS\njnx.4 = STRING: MASSEY-WIFI",
            // Q-BRIDGE present too, but must be ignored in favour of the Juniper MIB.
        ...
        $this->assertNull($vlans[2] ?? null);   // the internal index is NOT stored as a VLAN
    }
