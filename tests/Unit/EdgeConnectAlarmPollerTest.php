...
class EdgeConnectAlarmPollerTest extends TestCase
{
    ...
    public function test_new_alarm_gets_a_sequential_ticket(): void
    {
        $device = $this->device();
        ...
        $this->assertMatchesRegularExpression('/^[A-Z]+-ALM-\d{6}$/', $ticket);
    }
    ...
    public function test_cleared_alarm_reopens_with_new_ticket_after_a_flap(): void
    {
        ...
        $this->assertMatchesRegularExpression('/^[A-Z]+-ALM-\d{6}$/', $alarm->ticket_number);
    }
