...
class SnmpIdentityPollerTest extends TestCase
{
    ...
    public function test_silverpeak_model_serial_and_version_come_from_the_silverpeak_mib(): void
    {
        ...
        (new SnmpIdentityPoller($this->walker([
            '.1.3.6.1.4.1.23867.3.1.1.1.2.0' => 'iso.3.6.1.4.1.23867.3.1.1.1.2.0 = STRING: "EC10104"',
            '.1.3.6.1.4.1.23867.3.1.1.1.1.0' => 'iso.3.6.1.4.1.23867.3.1.1.1.1.0 = STRING: "9.3.8.1_96913"',
            '.1.3.6.1.4.1.23867.3.1.1.1.6.0' => 'iso.3.6.1.4.1.23867.3.1.1.1.6.0 = STRING: "00-1B-BC-36-9E-88"',
        ])))->poll($device);
