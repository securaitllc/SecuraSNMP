...
class CircuitInventoryReportTest extends TestCase
{
    ...
    public function test_a_missing_lec_is_shown_as_a_gap_and_counted(): void
    {
        ...
        // Counted in the summary, but NOT toned per row: most DIA circuits legitimately
        // have no last-mile reseller, so a rail on every one would bury the real gaps.
        $this->assertArrayNotHasKey('lec_name', $report['rows'][0]['_tone']);
