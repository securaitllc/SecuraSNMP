...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // created below.
        // Never seed the placeholder admin password into production — a real deploy
        // MUST set SEED_ADMIN_PASSWORD, so the documented default can't ship live.
        if (app()->environment('production') && ! env('SEED_ADMIN_PASSWORD')) {
            throw new \RuntimeException('Refusing to seed in production without SEED_ADMIN_PASSWORD set — set a strong admin password in the environment before seeding.');
        }
        ...
        $this->call(CveCatalogSeeder::class);
    }
