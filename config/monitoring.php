...
return [
    ...
    // FortiGate firewalls: VPN tunnel state, HA sync, memory/disk/CPU. Same
    // reasoning as the EdgeConnect cadence — alarms are the operational priority
    // and the walks are light.
    'fortigate_alarm_interval' => (int) env('POLL_FORTIGATE_ALARM_SECONDS', 90),
];
