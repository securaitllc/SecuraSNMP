...
// Rate-limit login to blunt credential brute-forcing (per IP).
...
Route::middleware(['auth:sanctum', 'active'])->group(function () {
    ...
    // SLA / availability reporting + global quick search.
    Route::get('/sla', [SlaController::class, 'index']);
    Route::get('/sla/export', [SlaController::class, 'export']);
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        // Config backup / drift (configs may contain sensitive data — admin only).
        Route::get('/devices/{device}/configs', [DeviceConfigController::class, 'index']);
        Route::post('/devices/{device}/configs', [DeviceConfigController::class, 'store']);
        Route::get('/devices/{device}/configs/diff', [DeviceConfigController::class, 'diff']);
        Route::get('/device-configs/{device_config}', [DeviceConfigController::class, 'show']);
