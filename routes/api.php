...
Route::middleware(['auth:sanctum', 'active'])->group(function () {
    ...
    // read as a device id.
    Route::get('/devices/hostname-drift', [\App\Http\Controllers\Api\DeviceHostnameController::class, 'drift']);
    Route::post('/devices/adopt-hostnames', [\App\Http\Controllers\Api\DeviceHostnameController::class, 'adopt'])->middleware('role:admin');
    ...
    Route::post('/devices/{device}/maintenance', [\App\Http\Controllers\Api\DeviceMaintenanceController::class, 'store'])->middleware('role:analyst');
    Route::delete('/devices/{device}/maintenance', [\App\Http\Controllers\Api\DeviceMaintenanceController::class, 'destroy'])->middleware('role:analyst');
    ...
    Route::get('/ipam/ranges', [\App\Http\Controllers\Api\IpamController::class, 'ranges']);
    Route::get('/ipam/range', [\App\Http\Controllers\Api\IpamController::class, 'detail']);
    Route::get('/ipam/space', [\App\Http\Controllers\Api\IpamController::class, 'space']);
    Route::get('/ipam/reservations', [\App\Http\Controllers\Api\IpReservationController::class, 'index']);
    ...
    Route::get('/ipam/prefixes', [\App\Http\Controllers\Api\IpPrefixController::class, 'index']);
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::post('/ipam/prefixes', [\App\Http\Controllers\Api\IpPrefixController::class, 'store']);
        Route::put('/ipam/prefixes/{ipPrefix}', [\App\Http\Controllers\Api\IpPrefixController::class, 'update']);
        Route::delete('/ipam/prefixes/{ipPrefix}', [\App\Http\Controllers\Api\IpPrefixController::class, 'destroy']);
        Route::post('/ipam/reservations', [\App\Http\Controllers\Api\IpReservationController::class, 'store']);
        Route::put('/ipam/reservations/{ipReservation}', [\App\Http\Controllers\Api\IpReservationController::class, 'update']);
        Route::delete('/ipam/reservations/{ipReservation}', [\App\Http\Controllers\Api\IpReservationController::class, 'destroy']);
